...
$query = "INSERT INTO Referrals.Rx(PatientID, DateCreated, Status, ProviderID, Note, Authorization, presc1, mg1, quan1, dir1, dir21, presc2, mg2, quan2, dir2, dir22, presc3, mg3, quan3, dir3, dir23, presc4, mg4, quan4, dir4, dir24, presc5, mg5, quan5, dir5, dir25, Reason) VALUES
 ('" . $_GET['patientID'] . "', '" . $_GET['dateTime'] . "', '" . $_GET['status'] . "', '" . $_GET['provider'] . "', '" . $_GET['Note'] . "', '" . $_GET['authorization'] . "', '" .
